...
class MedicalDataRetrieval:
    ...
    def retrieve_data(self, query: str, k: int = 1):
        ...
        print(f"🧠 Disease: {response["hits"]["hits"][0]["_score"]}")
        # print(f"🧠 Disease: {response["hits"]["hits"][0]["_source"]["disease"]}")
        # print(f"Description: {response["hits"]["hits"][0]["_source"]["combined_text"]}\n")
...
if __name__ == "__main__":
    ...
    query = "I don't have enough information to create a summary. The conversation didn't include any discussion of symptoms or medical details."
